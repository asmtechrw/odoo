...
```
wget https://raw.githubusercontent.com/hrmuwanika/odoo/19.0/install_odoo_ubuntu.sh
```
...
```IS_ENTERPRISE``` will install the Enterprise version on top of ```19.0``` if you set it to ```True```, set it to ```False``` if you want the community version of Odoo 16.<br/>
